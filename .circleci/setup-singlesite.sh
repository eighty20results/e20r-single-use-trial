...
inc/bin/wp core install --path="${WP_CORE_DIR}" --url="http://${WP_HOST}" --title="Plugin Tests" --admin_user="admin" --admin_password="admin" --admin_email="thomas@eighty20results.com"
